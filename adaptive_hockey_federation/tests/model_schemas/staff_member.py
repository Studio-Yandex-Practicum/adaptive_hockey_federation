from tests.model_schemas.fields_validation_schemas import (
    ...
    DOUBLE_LAST_NAME, DOUBLE_PATRONYMIC, FIGURES_AND_LETTERS, INCORRECT_PHONE,
    LONGER_THEN_256, LOWER_SECOND_LAST_NAME, MIDDLE_CAP, NOT_CYR, NULL,
    PUNCTUATION_MARKS_EXCEPT_HYPHEN, SPACES, THE_ONLY_CYR_LETTER,
    TWO_OR_MORE_SPACES)
