...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="", help_text="Имя", max_length=256, verbose_name="Имя"
                    ),
                ),
                (
                    "patronymic",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_captain",
                    models.BooleanField(
                        default=False, help_text="Капитан", verbose_name="Капитан"
                    ),
                ),
                (
                    "is_assistent",
                    models.BooleanField(
                        default=False, help_text="Ассистент", verbose_name="Ассистент"
                    ),
                ),
                (
                    "identity_document",
        ...
        migrations.AddConstraint(
            model_name="player",
            constraint=models.UniqueConstraint(
                fields=("position", "number"), name="player_position_number_unique"
            ),
        ),
        migrations.AddConstraint(
            model_name="discipline",
